...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, help='Path to input image/folder of images.', default='/home/nata/Documents/melissa')
    parser.add_argument('--checkpoint', type=str, help='Path to model checkpoint', default='checkpoints/straps_model_checkpoint.tar')
    parser.add_argument('--silh_from', choices=['densepose', 'pointrend'], default='pointrend')
    parser.add_argument('--gpu', default='0')
    args = parser.parse_args()

    os.environ["CUDA_DEVICE_ORDER"] = "PCI_BUS_ID"  # see issue #152
    os.environ["CUDA_VISIBLE_DEVICES"] = args.gpu
    #device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu") #DEN DEBUG
